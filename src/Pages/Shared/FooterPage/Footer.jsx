...
const Footer = () => {
    return (
        <div className="my-10">
            ...
            <footer class="bg-blue-100/80  dark:bg-gray-900">
                <div class="container px-6 py-12 mx-auto">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800 dark:text-white">Survey Details</p>

                            <div class="flex flex-col items-start mt-5 space-y-2">
                                <Link to='/aboutus' class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">About us</Link>
                                ...
                                <p class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Terms of Service</p>
                            </div>
                        </div>
